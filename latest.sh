...
url="https://us-east.manta.joyent.com/wanelo/public/cache/chef/omnibus/smartos-base64-lts-0.0.0+20170113012350_1.i86pc.sh"
...
echo "Installing build essential, installing Chef version 12.4.3"
case "$filetype" in
  "sh" )
